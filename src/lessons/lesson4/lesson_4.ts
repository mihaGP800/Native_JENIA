...
// const pr2 = Promise.resolve(console.log('Promise Data'))
// console.dir(pr2)
...
// const pr3 = Promise.reject(console.log('Promise Error'))
// console.dir(pr3)
...
// })
//
// const onSuccess = (x: any) => {
//     return `${x} Miha`
// }
//
// const print = (a: string) => console.log(a)
//
// pr.then(response => onSuccess(response))
